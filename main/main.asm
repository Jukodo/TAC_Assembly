...
func_getHours proc
		...
		CALL 	func_getToday				; Data de HOJE
		MOV 	al ,DDMMAAAA[0]	
		MOV 	STR12[0], al	
		MOV 	al ,DDMMAAAA[1]	
		MOV 	STR12[1], al	
...
CICLO:	macro_GoTo	POSx,POSy
		...
		call 	func_lerTecla		; lê uma nova tecla
...
ciclo4:
		...
		mov	dl,cl	
		mov	dh,70
		push	dx		; Passagem de parâmetros a func_printInt (posição do ecran)
		push	ax		; Passagem de parâmetros a func_printInt (número a imprimir)
		call	func_printInt		; imprime 10 aleatórios na parte direita do ecran
...
novacor:	
		...
		mov	di,1 ;func_delay de 1 centesimo de segundo
		call	func_delay
...
;------------------------------------------------------
;func_printInt - imprime um numero de 16 bits na posicao x,y
;Parametros passados pela pilha
;entrada:
